...
const PASSWORD_POLICY_MESSAGE = '비밀번호는 8~20자이며, 영문·숫자·특수문자를 모두 포함해야 합니다.';
...
export default function ChangePasswordModal() {
  ...
  const validate = useCallback(() => {
    ...
    if (!form.newPasswordConfirm) {
      ...
      errors.newPasswordConfirm = '새 비밀번호와 확인이 일치하지 않습니다.';
    }
      ...
      >
        ...
        <div className="relative w-full max-w-sm bg-white rounded-lg shadow-xl p-8 mx-4">
          ...
          {formError && (
              <div
                  role="alert"
                  className="flex items-start gap-2 mb-4 p-3 rounded-md bg-red-50 text-red-700 text-sm"
              >
                <ErrorIcon />
                <span>{formError}</span>
              </div>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                    ...
                    aria-describedby={
                      fieldErrors.newPasswordConfirm ? `${id('confirm')}-error` : undefined
                    }
  ...
  return (
      ...
      >
        <path
            ...
            d="M2.458 10C3.732 5.943 7.523 3 12 3c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"
        />
